...
export const de: Translations = {
	...
	'port.notice.nothing': 'Von Toolbox ist nichts übrig.',
	'port.panel.title': 'Umzug von Toolbox',
	'port.panel.tidied': 'In den Papierkorb verschoben:',
	'port.panel.leftAlone': 'Vorerst unangetastet:',
	'port.panel.dismiss': 'Erledigt',
	'port.kind.pluginFolder': 'der alte Plugin-Ordner, {at}',
	'port.kind.panelLeaf': 'ein Panel, das noch unter dem alten Namen offen war',
	'port.kind.hotkeys': 'Tastenkürzel für die alten Befehle',
	'port.kind.ringFile': 'die Ringdatei unter {at}',
	'port.kind.rosterFolder': 'die Geräteliste unter {at}',
	'port.kind.ringFilePath': 'ein Ringpfad, der noch als {at} gespeichert war',
	'port.kind.folder': 'der Ordner {at}',
	'port.reason.notCarried': 'am neuen Ort liegt noch nichts, was das hier enthält',
	'port.reason.differentRing': 'es gehört zu einem anderen Ring als dem dieses Geräts',
	'port.reason.unreadable': 'es lässt sich nicht lesen, der Inhalt ist also unbekannt',
